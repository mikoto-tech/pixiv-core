...
public class HttpApi {
    ...
    public static final String DATABASE_CENTRAL_GET_USER_BY_USER_ID = "/getUserByUserId";
    public static final String DATABASE_CENTRAL_GET_USER_BY_USER_KEY = "/getUserByUserKey";
    ...
    public static final String DATABASE_FORWARD = "/forward";
    public static final String DATABASE_FORWARD_LOGIN = "/login";
